export const portfolioData = {
  ...
  featuredProject: {
    ...
    challenge: "Customers often face long wait times at popular restaurants and struggle to find places that match their dietary needs (Halal, Vegetarian, Gluten-free, etc.). Traditional queue systems require customers to stay physically near the restaurant, creating frustration, uncertainty, and wasted time.\n\nStudies show that 86% of customers avoid businesses with long queues, and 70% are unlikely to return after experiencing excessive waiting times. This suggests that queue management is not only an operational challenge but also a critical user experience problem.",
